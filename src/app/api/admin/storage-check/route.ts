...
export async function GET(request: NextRequest) {
  try {
    ...
    // SECURITY: Prevent timing attacks by using crypto.timingSafeEqual instead of ===
    // Avoid empty string fallback which could allow auth bypass if env var is missing
