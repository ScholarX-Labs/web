...
export async function GET(request: NextRequest) {
  try {
    ...
    // Use timing-safe comparison to prevent timing attacks, and ensure we don't bypass auth
    // if the environment variable is missing and the user sends an empty string.
