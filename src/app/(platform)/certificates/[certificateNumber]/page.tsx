...
async function getCertificate(certificateNumber: string) {
  ...
  return domain.certificate.getCertificateByNumber(certificateNumber);
}
...
export async function generateMetadata({
  ...
  return {
    title: `${certificate.metadata.courseTitle} Certificate | ScholarX`,
    description: `Verified ScholarX certificate for ${certificate.metadata.learnerDisplayName}.`,
  };
}
