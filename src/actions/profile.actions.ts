...
const socialLinksSchema = z.object({
  githubUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
  facebookUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
  instagramUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
  twitterUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
  linkedinUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
});
