...
const socialLinksSchema = z.object({
  githubUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
  facebookUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
  instagramUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
  twitterUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
  linkedinUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
});
