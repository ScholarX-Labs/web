...
export const CreateCourseSchema = z.object({
  ...
  imageUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
  videoPreviewUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
...
export const CreateLessonSchema = z.object({
  ...
  videoUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must be an HTTP or HTTPS URL").optional().or(z.literal("")),
