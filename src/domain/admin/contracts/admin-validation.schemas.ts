...
export const CreateCourseSchema = z.object({
  ...
  imageUrl: z.string().url().refine(val => !val || /^https?:\/\//i.test(val), "URL must start with http:// or https://").optional().or(z.literal("")),
  videoPreviewUrl: z.string().url().refine(val => !val || /^https?:\/\//i.test(val), "URL must start with http:// or https://").optional().or(z.literal("")),
...
export const CreateLessonSchema = z.object({
  ...
  videoUrl: z.string().url().refine(val => !val || /^https?:\/\//i.test(val), "URL must start with http:// or https://").optional().or(z.literal("")),
