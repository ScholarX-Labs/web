...
export const CreateCourseSchema = z.object({
  ...
  imageUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
  videoPreviewUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
...
export const CreateLessonSchema = z.object({
  ...
  videoUrl: z.string().url().refine(s => s.toLowerCase().startsWith("http://") || s.toLowerCase().startsWith("https://"), "Must be a valid HTTP/HTTPS URL").optional().or(z.literal("")),
