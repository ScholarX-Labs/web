...
export const CreateCourseSchema = z.object({
  ...
  imageUrl: z.string().url().refine((s) => s.startsWith("http://") || s.startsWith("https://"), { message: "URL must be http or https" }).optional().or(z.literal("")),
  videoPreviewUrl: z.string().url().refine((s) => s.startsWith("http://") || s.startsWith("https://"), { message: "URL must be http or https" }).optional().or(z.literal("")),
...
export const CreateLessonSchema = z.object({
  ...
  videoUrl: z.string().url().refine((s) => s.startsWith("http://") || s.startsWith("https://"), { message: "URL must be http or https" }).optional().or(z.literal("")),
