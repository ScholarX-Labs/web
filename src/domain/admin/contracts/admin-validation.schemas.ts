...
export const CreateCourseSchema = z.object({
  ...
  imageUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must use http/https").optional().or(z.literal("")),
  videoPreviewUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must use http/https").optional().or(z.literal("")),
...
export const CreateLessonSchema = z.object({
  ...
  videoUrl: z.string().url().refine((val) => /^https?:\/\//i.test(val), "Must use http/https").optional().or(z.literal("")),
