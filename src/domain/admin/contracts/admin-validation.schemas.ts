...
export const CreateCourseSchema = z.object({
  ...
  imageUrl: z.union([z.literal(""), z.string().url().refine(val => /^https?:\/\//i.test(val), 'URL must be http or https').optional()]),
  videoPreviewUrl: z.union([z.literal(""), z.string().url().refine(val => /^https?:\/\//i.test(val), 'URL must be http or https').optional()]),
...
export const CreateLessonSchema = z.object({
  ...
  videoUrl: z.union([z.literal(""), z.string().url().refine(val => /^https?:\/\//i.test(val), 'URL must be http or https').optional()]),
