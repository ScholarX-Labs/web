          ...
          <div className="relative w-full lg:w-[44%] min-h-[260px] lg:min-h-[640px] overflow-hidden bg-slate-950">
            ...
            <div className="relative flex min-h-0 flex-1 flex-col">
              ...
              <div className="relative flex-1 min-h-0 overflow-hidden group">
                <div className="pointer-events-none absolute inset-x-0 top-0 z-20 h-8 w-full bg-linear-to-b from-white/95 to-transparent dark:from-slate-950/95" />
                <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 h-12 w-full bg-linear-to-t from-white/95 to-transparent dark:from-slate-950/95" />
