...
export function EnrollModal({
  ...
  const visualPhase = isSuccess ? "success" : isEnrolling ? "processing" : "open";
  ...
  const handleEnrollFree = async () => {
    ...
    try {
      console.log("[ENROLL] calling executeEnrollment with context:", executionContext);
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <motion.div
            ...
            transition={
              shouldReduceMotion
                ? undefined
                : { duration: 9.5, repeat: Infinity, ease: "easeInOut", delay: 0.35 }
            }
          />
        </div>
              ...
              <div className="p-6 space-y-6">
                <div className="space-y-4">
                  ...
                  <motion.ul
                    className="space-y-3"
                    initial={false}
                    animate={{ transition: { staggerChildren: shouldReduceMotion ? 0 : 0.06 } }}
                  >
                    <motion.li
                ...
                <div className="pt-2">
                  {!isPaid ? (
                    <motion.div
                      animate={shouldReduceMotion ? undefined : { scale: isEnrolling ? 1 : 1 }}
