...
export function SocialProofRibbon({
  ...
  return (
    <div
      className={cn(
        "absolute top-14 right-3 z-30 flex flex-col gap-2 items-end drop-shadow-md",
        className,
      )}
    >
      {isBestseller && (
        <div className="bg-linear-to-r from-amber-400 to-yellow-500 text-white text-[10px] font-black uppercase tracking-widest py-1 px-3 rounded-full shadow-[0_4px_10px_rgba(251,191,36,0.5)] border border-yellow-300 ring-1 ring-white/50 flex items-center gap-1 overflow-hidden relative group">
