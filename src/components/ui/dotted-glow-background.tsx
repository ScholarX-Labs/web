/**
 * @file dotted-glow-background.tsx
 * @description A high-performance, canvas-based ambient dot grid background with dynamic glowing and pulsing animations.
 *
 * @usage_guidelines
 * - Perfect for landing pages, portfolio hero sections, and card backdrops to add premium visual depth.
 * - Uses HTML5 Canvas for performance: handles hundreds of glowing dots at 60fps without triggering React re-renders.
 * - Handles high-DPI (Retina) screens and monitors resize events dynamically using ResizeObserver.
 * - Supports an IntersectionObserver to pause the animation loops when the component is off-screen, conserving CPU/battery.
 *
 * @dark_mode_notes
 ...
 *   reflect dark/light variant CSS variables (e.g. `--color-neutral-500` or `--color-sky-800`).
 * - Integrate the "Fancy Dark Mode Toggle" to transition classes on `html` smoothly, which triggers the
 *   internal MutationObserver in this component to compute and fade between light and dark colors instantly.
 */
