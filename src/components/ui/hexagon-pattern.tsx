/**
 * @file hexagon-pattern.tsx
 * @description A premium background hexagon pattern component built with customizable SVGs.
 * Developed in accordance with Google Principal SWE guidelines.
 *
 * Design Guidelines & Theme Considerations:
 * - Hexagon spacing and radii are fully configurable via the `radius` and `gap` properties.
 * - Colors (stroke, fill) are controlled dynamically using standard Tailwind CSS classes.
 * - Compatible with a "Fancy Dark Mode Toggle": using thin, semi-translucent strokes (e.g., `stroke-neutral-400/30`) 
 *   allows the pattern to blend beautifully across light and dark theme backgrounds.
 *
 * Usage:
 * ```tsx
 ...
 *     gap={4}
 *     hexagons={[[0, 0], [1, 2]]}
 *     className="stroke-neutral-400/30 dark:stroke-zinc-700/30"
 *   />
 * </div>
 * ```
 */
