...
const MacOSDock: React.FC<MacOSDockProps> = ({
  ...
  const animateToTarget = useCallback(() => {
    ...
    setCurrentScales((prev) =>
      prev.map((currentScale, index) => currentScale + (targetScales[index] - currentScale) * lerpFactor),
    )
    setCurrentPositions((prev) =>
      prev.map((currentPos, index) => currentPos + (targetPositions[index] - currentPos) * lerpFactor),
    )
