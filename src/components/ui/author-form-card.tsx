  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <motion.h3 variants={FADE_IN_VARIANTS as any} className="text-xl font-semibold text-foreground">
          Add a writer
        </motion.h3>
      ...
      <form onSubmit={handleSubmit} className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-3">
        <motion.div variants={FADE_IN_VARIANTS as any} className="flex flex-col items-center gap-3 md:col-span-1">
        ...
        <div className="flex flex-col gap-4 md:col-span-2">
          <motion.div variants={FADE_IN_VARIANTS as any} className="grid w-full items-center gap-1.5">
        ...
        <motion.div variants={FADE_IN_VARIANTS as any} className="flex justify-end gap-3 md:col-span-3">
