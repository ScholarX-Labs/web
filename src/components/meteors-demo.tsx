/**
 * @file meteors-demo.tsx
 * @description Demo showcase of the Meteors component inside a stylized card component.
 *
 * @usage_guidelines
 * - Renders a card container with an absolute positioned background gradient glow.
 * - Spawns 20 dynamic shooting meteors animating diagonally downwards.
 *
 * @dark_mode_notes
