...
shell commands, and other important information, read `specs/016-course-leaderboard/plan.md`, `specs/017-admin-cash-enrollment/plan.md`, and `specs/018-bunny-net-video-migration/plan.md`.
<!-- SPECKIT END -->
