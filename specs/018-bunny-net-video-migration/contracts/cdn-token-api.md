...
```json
{
  ...
  "data": {
    ...
    "expires": 1721380800,
    "signedUrl": "https://vz-123.b-cdn.net/bcdn_token=HS256-5a5de480...&expires=1721380800&token_path=%2Fvideos%2F/videos/lesson.m3u8"
  }
}
```
...
- HMAC-SHA256 signing with Video Library API Key
