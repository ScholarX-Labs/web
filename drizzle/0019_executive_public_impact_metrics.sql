...
CREATE TABLE IF NOT EXISTS "executive"."public_impact_metrics" (
  ...
  "owner_id" text NOT NULL REFERENCES "app_auth"."user"("id"),
  "approval_status" varchar(32) NOT NULL DEFAULT 'draft',
  "proposed_by" text REFERENCES "app_auth"."user"("id") ON DELETE SET NULL,
  "approved_by" text REFERENCES "app_auth"."user"("id") ON DELETE SET NULL,
  "approved_at" timestamp,
  "rejected_by" text REFERENCES "app_auth"."user"("id") ON DELETE SET NULL,
