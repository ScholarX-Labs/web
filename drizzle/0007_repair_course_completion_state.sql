-- Repair migration for environments where 0006_course_completion_state was
-- marked applied in the Drizzle journal but the schema objects were not
-- actually created. This migration is intentionally idempotent.
